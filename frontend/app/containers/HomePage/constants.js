...
export const RECEIVED_CLEAR_CACHE = "RECEIVED_CLEAR_CACHE";
export const COMPANIES_CACHE_HIT = "COMPANIES_CACHE_HIT";
export const VEHICLES_CACHE_HIT = "VEHICLES_CACHE_HIT";
// ** OTHER ** //
export const STATUS_OPTIONS = [
  { value: 1, label: "Not Responding" },
